...
export const RACE_FEATURES: Record<string, Feature[]> = {
    Dragonborn: [
        ...
        {
            name: 'Breath Weapon',
            description: 'You can use your action to exhale destructive energy. Each creature in the area must make a saving throw. A creature takes 2d6 damage on a failed save, and half as much on a successful one. The damage increases to 3d6 at 6th level, 4d6 at 11th level, and 5d6 at 16th level.',
            damageDice: '2d6',
            damageType: 'varies',
        },
        {
    ...
    Aasimar: [
        {
            name: 'Darkvision',
            description: 'Thanks to your celestial heritage, you have superior vision in dark and dim conditions. You can see in dim light within 60 feet of you as if it were bright light, and in darkness as if it were dim light.',
        },
        {
        ...
        {
            name: 'Radiant Soul',
            description: 'Starting at 3rd level, you can use your action to unleash the divine energy within yourself, gaining a flying speed of 30 feet and dealing extra radiant damage equal to your level once per turn. The transformation lasts for 1 minute.',
        },
    ],
    Firbolg: [
        {
    ...
    Lizardfolk: [
        ...
        },
        {
            ...
            description: 'As part of a short rest, you can harvest bone and hide from a slain beast, construct, dragon, monstrosity, or plant creature to create a shield, club, javelin, or 1d4 darts or blowgun needles.',
        },
        {
            name: 'Hold Breath',
            description: 'You can hold your breath for up to 15 minutes at a time.',
        ...
        {
            name: 'Hungry Jaws',
            description: 'You can make a special attack with your bite. If you hit with it, you gain temporary hit points equal to your Constitution modifier (minimum 1). You can use this trait a number of times equal to your Constitution modifier, and you regain all expended uses when you finish a long rest.',
            damageDice: '1d6',
            damageType: 'piercing',
        },
        {
            name: 'Natural Armor',
            description: 'You have tough, scaly skin. When you aren\'t wearing armor, your AC is 13 + your Dexterity modifier. A shield\'s benefits apply as normal while you use your natural armor.',
        },
    ],
    Tabaxi: [
        {
            name: 'Cat\'s Claws',
            description: 'You have a climbing speed of 20 feet. In addition, your claws are natural weapons, which you can use to make unarmed strikes. If you hit with them, you deal slashing damage equal to 1d4 + your Strength modifier.',
            damageDice: '1d4',
            damageType: 'slashing',
        },
        {
    ...
    Tortle: [
        ...
        {
            name: 'Natural Armor',
            description: 'Due to your shell and the shape of your body, you are ill-suited to wearing armor. Your shell provides ample protection; it gives you a base AC of 17 (your Dexterity modifier doesn\'t affect this number).',
        },
        {
            name: 'Shell Defense',
