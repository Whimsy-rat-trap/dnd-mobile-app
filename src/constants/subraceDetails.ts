...
export const SUBRACE_DETAILS: Record<string, SubraceDetail> = {
    ...
    'Dark Elf (Drow)': {
        ...
        features: [
            {
                name: 'Drow Magic',
                description: 'You know the Dancing Lights cantrip. When you reach 3rd level, you can cast the Faerie Fire spell once per day. When you reach 5th level, you can cast the Darkness spell once per day. Charisma is your spellcasting ability for these spells.'
            },
            {
        ...
        features: [
            {
                ...
                description: 'You know the Thaumaturgy cantrip. When you reach 3rd level, you can cast the Disguise Self spell once per day. When you reach 5th level, you can also cast the Invisibility spell once per day. Charisma is your spellcasting ability for these spells.'
            }
        ]
    },
    'Fierna': {
        ...
        features: [
            {
                ...
                description: 'You know the Friends cantrip. When you reach 3rd level, you can cast the Charm Person spell once per day. When you reach 5th level, you can also cast the Suggestion spell once per day. Charisma is your spellcasting ability for these spells.'
            }
        ]
    },
    'Glasya': {
    ...
    'Green': {
        ...
        features: [
            {
                name: 'Poison Breath',
                description: 'Your breath weapon deals poison damage. Each creature in the area must make a Constitution saving throw (DC 8 + your Constitution modifier + your proficiency bonus). A creature takes 2d6 poison damage on a failed save, and half as much on a successful one. The damage increases to 3d6 at 6th level, 4d6 at 11th level, and 5d6 at 16th level.'
            },
            {
    ...
    'Silver': {
        ...
        features: [
            {
                name: 'Cold Breath',
                description: 'Your breath weapon deals cold damage. Each creature in the area must make a Constitution saving throw (DC 8 + your Constitution modifier + your proficiency bonus). A creature takes 2d6 cold damage on a failed save, and half as much on a successful one. The damage increases to 3d6 at 6th level, 4d6 at 11th level, and 5d6 at 16th level.'
            },
            {
