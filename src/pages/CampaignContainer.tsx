        ...
        <div className="cg-page">
            ...
            <div className="cg-content">
                ...
                <div className="cg-create-card">
                    <div className="cg-create-icon" onClick={() => setIsCreating(true)} style={{ cursor: 'pointer' }}>
                    ...
                    <button className="cg-create-button" onClick={() => setIsCreating(true)}>
                        Create campaign
                    </button>
                </div>
                ...
                <section className="cg-section">
                    <div className="cg-section-header">
                        <h2 className="cg-section-title">Active Campaigns</h2>
                        <span className="cg-view-all" onClick={() => {}} style={{ cursor: 'pointer' }}>View All</span>
                    </div>
                                        ...
                                        <div className="cg-card-info">
                                            ...
                                            <div className="cg-card-stats">
                                                <div className="cg-stats-group">
                                                    ...
                                                    <span className="cg-stats-text">{campaign.players || 4} players</span>
                                                </div>
                                                <div className="cg-stats-group">
                                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <span className="cg-stats-text">{campaign.sessions || 3} sessions</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="cg-card-footer">
                                        <span className="cg-card-date">{formatLastPlayed(lastPlayed)}</span>
                                        <div
                ...
                <div className="popup-overlay" onClick={() => setIsCreating(false)}>
                    <div className="popup-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <input
                            ...
                            onChange={(e) => setNewCampaign({ ...newCampaign, players: Number(e.target.value) })}
                        />
                        <input
                            type="number"
                        ...
                        <div className="popup-actions">
                            ...
                            <button className="btn-confirm" onClick={handleCreateCampaign}>Create</button>
                        </div>
                    </div>
                </div>
            )}
