            ...
            <div className="campaign-content">
                ...
                <section className="campaign-section">
                    <div className="section-header">
                        ...
                        <span className="view-all" onClick={() => {}} style={{ cursor: 'pointer' }}>View All</span>
                    </div>
                                ...
                                <div key={campaign.id} className="campaign-card">
                                    <div className="campaign-header-inner">
                                        ...
                                        <div className="campaign-info">
                                            ...
                                            <div className="campaign-dm">DM: {campaign.dm || 'Dungeon Master'}</div>
                                            <div className="campaign-stats">
                                                <div className="stats-group">
                                                    ...
                                                    <span className="stats-text">{campaign.players || 4} players</span>
                                                </div>
                                                <div className="stats-group">
                                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <span className="stats-text">{campaign.sessions || 3} sessions</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="campaign-footer">
                                        <span className="campaign-date">{formatLastPlayed(lastPlayed)}</span>
                                        <div
